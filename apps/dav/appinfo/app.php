...
$eventDispatcher->addListener('\OC\User\Manager::createUser',
	function(GenericEvent $event) use ($app) {
...
$eventDispatcher->addListener('\OC\User\User::deletePre',
	function(GenericEvent $event) use ($app) {
		$hookManager = $app->getContainer()->query(\OCA\DAV\HookManager::class);
...
$eventDispatcher->addListener('\OC\User\User::deletePost',
	function(GenericEvent $event) use ($app) {
		$hookManager = $app->getContainer()->query(\OCA\DAV\HookManager::class);
...
$eventDispatcher->addListener('\OC\User\User::triggerChange',
	function(GenericEvent $event) use ($app) {
		$hookManager = $app->getContainer()->query(\OCA\DAV\HookManager::class);
